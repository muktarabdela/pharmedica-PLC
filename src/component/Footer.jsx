...
export default function Footer() {
    ...
    return (
        <footer className="bg-[#04477c] text-primary-foreground">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <div className="flex space-x-4">
                            ...
                            <SocialIcon icon={twitterIcon} href="https://twitter.com/yourprofile" />
                            <SocialIcon icon={linkedinIcon} href="https://www.linkedin.com/in/yourprofile" />
                            {/* <SocialIcon icon={emailIcon} href="mailto:your-email@example.com" />
                            <SocialIcon icon={phoneIcon} href="tel:+25199626111" /> */}
                            <SocialIcon icon={youtubeIcon} href="https://www.youtube.com/c/yourprofile" />
                            <SocialIcon icon={tiktokIcon} href="https://www.tiktok.com/@yourprofile" />
                            <SocialIcon icon={TelegramIcon} href="https://t.me/yourprofile" />
                        </div>
                    </div>
...
function SocialIcon({ icon, href }) {
    return (
        <a href={href} target="_blank" rel="noopener noreferrer" className="hover:text-primary-foreground/80 transition-colors">
            {icon}
        </a>
    );
}
