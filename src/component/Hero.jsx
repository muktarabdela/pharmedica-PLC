            ...
            <div className="flex flex-col lg:flex-row bg-[#] p-6 lg:p-12 rounded-lg shadow-lg max-w-7xl mx-auto">
                ...
                <div className="lg:w-[50%] w-full relative">
                    ...
                    <div className="absolute -bottom-14 lg:bottom-4 lg:left[-20px] sm:left-[-40px] lg:left-[-60px] bg-white p-3 rounded-md shadow-md">
                        <p className="font-medium text-[#004D40]">Healthcare Solutions</p>
                        <p className="text-xs text-[#004D40]">We specialize in innovative technology integration for healthcare systems.</p>
                        <div className="flex items-center mt-2 space-x-2">
                            <div className="bg-[#00796B] text-white rounded-full w-[32px] h-[32px] flex items-center justify-center">
                                <i className="fa-solid fa-hospital-user"></i>
                            </div>
                            <div className="text-sm">
                                <p className="font-semibold text-[#004D40]">100+ Clients</p>
                                <p className="text-xs text-[#004D40]">Trusted Partners</p>
                            </div>
                        </div>
                    </div>
                </div>
