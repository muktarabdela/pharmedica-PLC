            ...
            <div className="container mx-auto px-4">
                ...
                <section>
                    ...
                    <p className="text-lg text-muted-foreground text-center mb-12 max-w-3xl mx-auto">
                        Thank you for considering PharMedica as your consultancy partner. Our commitment to excellence sets us apart and makes us the ideal choice for your healthcare projects.
                    </p>
        ...
        <Card className="w-full bg-[#06487c]">
            <CardContent className="flex items-start p-4 space-x-2">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground text-gray-300">{description}</p>
                </div>
            </CardContent>
        </Card>
    )
